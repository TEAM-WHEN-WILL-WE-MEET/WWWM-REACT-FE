...
export const colorVariants = cva('', {
  variants: {
    ...
    border: {
        ...
        'gray-50': 'border-[var(--gray-50)]',
        'gray-100': 'border-[var(--gray-100)]',
        'gray-200': 'border-[var(--gray-200)]',
        'gray-300': 'border-[var(--gray-300)]',
        'gray-400': 'border-[var(--gray-400)]',
        'gray-500': 'border-[var(--gray-500)]',
        'gray-600': 'border-[var(--gray-600)]',
        'gray-700': 'border-[var(--gray-700)]',
        'gray-800': 'border-[var(--gray-800)]',
        'gray-900': 'border-[var(--gray-900)]',
        'magen-50': 'border-[var(--magen-50)]',
        'magen-100': 'border-[var(--magen-100)]',
        'magen-300': 'border-[var(--magen-300)]',
        'magen-900': 'border-[var(--magen-900)]',
        'red-50': 'border-[var(--red-50)]',
        'red-100': 'border-[var(--red-100)]',
        'red-300': 'border-[var(--red-300)]',
        'NB-50': 'border-[var(--NB-50)]',
        'NB-100': 'border-[var(--NB-100)]',
        'NB-200': 'border-[var(--NB-200)]',
        'NB-300': 'border-[var(--NB-300)]',
        'NB-900': 'border-[var(--NB-900)]',
        'kakao-yellow': 'border-[var(--kakao-yellow)]',
        'kakao-black':'border-[var(--kakao-black)]',
